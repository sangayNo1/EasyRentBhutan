...
// Get all available apartments EXCEPT those belonging to this owner
$query = "SELECT * FROM apartments WHERE status = 'available' AND owner_id != ? ORDER BY created_at DESC";
